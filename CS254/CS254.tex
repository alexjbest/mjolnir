...
\tableofcontents
~\\
These are some notes I typeset for CS254 Algorithmic graph theory in 2013, they are currently full of gaps, mistakes, wrong statements and other badness.
...
(Delete and edge from $H$ -- we obtain a path i.e. a tree). \\
