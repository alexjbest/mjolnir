...
To make an interactive proof that a formula $\Phi$ is not satisfiable we instead make an interactive proof that the \emph{number} of satisfying assignments is exactly $K$.
%TODO
