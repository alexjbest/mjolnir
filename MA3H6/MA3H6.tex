...
\begin{thm}
Suppose $ 0\to A_* \xrightarrow{i_\#} B_* \xrightarrow{j_\#} C_* \to 0$ is exact then there is a $\partial_*\colon H_{* + 1}(C) \to H_*(A)$ making
\[
...
We sometimes draw this as an exact triangle
\[
\xymatrix
{
